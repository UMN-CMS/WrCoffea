...
for channel in channels:
    for region in regions:
        ...
        for mass in masses:
            card_file = f"{outdir}/{Year}/WR_{channel}_{region}_{mass}.txt"
            print(f"[INFO] Creating datacard for {channel} {region} {mass}")
            sig_file = f"rootfiles/{Year}/WRAnalyzer_signal_{mass}.root"
            ...
            with open(card_file, "w") as f:
                ...
                for group, samples in groups.items():
                    ...
                    for sample in samples:
                        sample_file = f"rootfiles/{Year}/WRAnalyzer_{sample}.root"
                        #print(sample_file)
                    ...
                    # if (i >=1):
                    tmpfile = f"rootfiles/{Year}/WRAnalyzer_{group}.root"
