...
# Configuration
# --------------------------
Year = "RunII/2018/RunIISummer20UL18"
channels = ["EE", "MuMu"]
regions = ["Resolved"]
...
for channel in channels:
    for region in regions:
        ...
        for mass in masses:
            card_file = f"{outdir}/WR_{channel}_{region}_{mass}.txt"
            ...
            with open(card_file, "w") as f:
                ...
                for group, samples in groups.items():
                    ...
                    for sample in samples:
                        sample_file = f"WR_Plotter/rootfiles/{Year}/WRAnalyzer_{sample}.root"
                        #print(sample_file)
                    ...
                    # if (i >=1):
                    tmpfile = f"WR_Plotter/rootfiles/{Year}/WRAnalyzer_{group}.root"
