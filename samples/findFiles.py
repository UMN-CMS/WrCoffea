...
for process, dataset_list in mc_samples.items():
  if os.path.exists('{}.txt'.format(process)): 
      os.system('rm {}.txt'.format(process))
  for dataset in dataset_list:
    print('Finding {} samples for {}'.format(process,dataset))
    os.system('dasgoclient -query="file dataset={}" >> {}.txt'.format(dataset,process))
